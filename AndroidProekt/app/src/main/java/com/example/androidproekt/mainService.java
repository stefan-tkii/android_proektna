...
public class mainService extends Service {
    ...
    public static final int NOTF_ID = 102;
    ...
    class Task extends TimerTask
    {
        ...
        public void run() {
            ...
            if(isWifi)
            {
                ...
                String url = "http://192.168.1.103:8080/PHP_API/api/user/read_single_ssid.php/?ssid=" + String.valueOf(ssid);
                try {
                    ...
                    url = "http://192.168.1.103:8080/PHP_API/api/variable/create_variable.php";
...
/* public void sendCancelNotification()
    {
        Log.e("CancelNotification", "Sending the cancel notification");
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            Intent actionIntent = new Intent(this,  mainService.class);
            actionIntent.setAction(ACTION_STOP_SERVICE);
            PendingIntent pend = PendingIntent.getService(getApplicationContext(), 0, actionIntent, PendingIntent.FLAG_CANCEL_CURRENT);
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID);
            NotificationManager manager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
            assert manager != null;
            manager.cancel(NOTF_ID);
            Notification notif = builder.setContentTitle("Service running").setContentText("Click here to cancel the service")
                    .setSmallIcon(R.drawable.ic_canceler).setAutoCancel(true)
                    .addAction(R.mipmap.ic_launcher, "Stop service", pend)
                    .build();
        ...
        else
        {
            ...
            manager.cancel(NOTF_ID);
            Notification notif = builder.setContentTitle("Service running").setContentText("Click here to cancel the service")
                    .setSmallIcon(R.drawable.ic_canceler).setAutoCancel(true).setLights(0xff00ff00, 300, 100)
                    .addAction(R.mipmap.ic_launcher, "Stop service", pend)
                    .build();
            manager.notify(NOTF_ID, notif);
        }
